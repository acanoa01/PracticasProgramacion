...
public class Apartado030102 extends Apartado {
	...
	public void ejercicio04() {
		...
		System.out.println("Introduzc el 1� n�mero: ");
		num1=Teclado.readInteger();
		System.out.println("Introduzc el 2� n�mero: ");
		...
		//Divisores
			...
			System.out.println("Opci�n incorrecta"); //Si la opcion es >3 o <1
	...
	public void ejercicio05() {
		...
		int a=1, b= -5, c=6; //Modificar los valores para realizar pruebas o leerlos por teclado
	...
	public void ejercicio06() {
		cabecera("06", "Comparación de números");

		// Inicio modificacion
		int num1,num2,num3;
		System.out.println("Introduzc el 1 número: ");
		num1=Teclado.readInteger();
		System.out.println("Introduzc el 2 número: ");
		num2=Teclado.readInteger();
		System.out.println("Introduzc el 3 número: ");
		num3=Teclado.readInteger();
		
		//El num1 es el mayor de los 3
		if( (num1>num2)&& (num1>num3) ) {
			System.out.println("El num1:"+num1+" es el mayor");
		}
		else if( (num2>num1) && (num2>num3) ){
			System.out.println("Eln num2:"+num2+" es el mayor");
		}else if(num3>num1 && num3>num2) {
			System.out.println("El num3:"+num3+" es el mayor");
		}
		//Igualdad entre números
		if( num1==num2)
			System.out.println("El num1 y el num2 son iguales");
		else if( num1==num3)
			System.out.println("El num1 y el num3 son iguales");
		else
			System.out.println("El num2 y el num3 son iguales");
